...
export const product: Product = {
  ...
  description: "Inspect a failed support-agent trace, isolate deterministic failure modes, propose bounded patches, and turn the incident into permanent regression checks.",
  accent: "#f04f78",
  ...
  status: "PATCH_READY",
  statusTone: "warn",
  metrics: [{ value: "5", label: "trace events" }, { value: "3", label: "failure modes" }, { value: "3", label: "regression tests" }],
  findings: [
