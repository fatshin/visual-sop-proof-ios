        ...
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            ...
            <span className="fixture-label">
              No sign-in · precomputed from the tested fixture
            </span>
          </div>
        </div>
      ...
      <section className="demo-section" id="demo">
        <div className="section-heading">
          <div>
            ...
            <h2>Reveal the verified fixture.</h2>
          </div>
          ...
          >
            {!hasRun ? (
              <div className="waiting">
                <span>01</span>
                <h3>The tested result is ready to inspect.</h3>
                <p>
                  Reveal the expected decision generated by the product&apos;s
              ...
              <>
                <div className="result-topline">
                  <span>Verified fixture result</span>
